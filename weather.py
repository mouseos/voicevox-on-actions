...
text=(greet+"""この時間はAIアナウンサーが"""+data['location']['district']+"""の気象情報をお伝えします。まずは、天気概況をお伝えします。
"""+re.sub('雨',"あめ",(data['description']["bodyText"]))+"""それでは"""+data['location']['district']+"""の天気をお伝えします。"""+data['location']['district']+"の"+forecasts+"以上、voicevox、九州そらが気象庁発表の気象情報をお伝えしました。")
